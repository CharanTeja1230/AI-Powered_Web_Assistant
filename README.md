...
<p align="center">
  <span style="background: linear-gradient(45deg, #12c2e9, #c471ed, #f64f59); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
    <strong>Maintainer: Charan Teja</strong>
  </span>
</p>
<p align="center">
...
## Maintainer
Maintainer: Charan Teja

### Credits & Acknowledgments
- **Lead Maintainer & Owner**: Charan Teja
- **Original Contributors & Community**: Credits to original open-source framework contributors for foundational research.

Thank you for using and contributing to LUMO (Learning Unified Multimodal Oracle) — built and maintained by Charan Teja.
